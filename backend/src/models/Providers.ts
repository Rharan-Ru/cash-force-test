...
export type ProviderInput = ProviderAttributes
export type ProviderOuput = Required<ProviderAttributes>

class Provider extends Model<ProviderAttributes, ProviderInput> implements ProviderAttributes {
    public id!: number
    public name!: string
